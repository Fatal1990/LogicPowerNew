<template>
  <div class="delivery-list">
    <SelectGroup :caption="'Область'" />
    <SelectGroup :caption="'Город'" />
    <SelectGroup :caption="'Отделение'" />
  </div>
</template>
...
@Component({
  name: "NovaPoshtaWarehouseComponent",
  components: {
    SelectGroup,
  },
})
export default class NovaPoshtaWarehouseComponent extends Vue {}
</script>
